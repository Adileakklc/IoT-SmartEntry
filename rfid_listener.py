...
def clear_console():
    console_area.config(state="normal")   # önce aktif yap
    console_area.delete(1.0, tk.END)      # sonra temizle
    console_area.config(state="disabled") # tekrar pasif yap
            ...
            while True:
                ...
                try:
                    ...
                    if data["durum"].lower() == "yetkili":
                        speak("Hos geldiniz, gecis yetkiniz onaylandi!")
                    else:
                        speak("Üzgünüz, bu kartla giris izni yok.")
